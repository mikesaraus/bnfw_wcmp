jQuery(document).ready(function ($) {
  ...
  function init() {
    ...
    if (
      ...
      notification.startsWith('commentreply-') ||
      'new-user' === notification ||
      'welcome-email' === notification ||
      'user-password' === notification ||
      'password-changed' === notification ||
      'email-changed' === notification ||
      'email-changing' === notification ||
      'user-role' === notification ||
      'ca-export-data' === notification ||
      'ca-erase-data' === notification ||
      'uc-export-data' === notification ||
      'uc-erase-data' === notification ||
      'data-export' === notification ||
      'data-erased' === notification ||
      'multisite-new-user-invited' === notification ||
      'multisite-new-user-created' === notification ||
      'multisite-new-user-welcome' === notification ||
      'multisite-site-registered' === notification ||
      'multisite-site-welcome' === notification ||
      'multisite-site-created' === notification ||
      'multisite-site-deleted' === notification ||
      'multisite-site-admin-email-change-attempted' === notification ||
      'multisite-site-admin-email-changed' === notification ||
      'multisite-network-admin-email-change-attempted' === notification ||
      'multisite-network-admin-email-changed' === notification
    ) {
      ...
      if (
        ...
        'ca-erase-data' === notification ||
        'data-erased' === notification ||
        -1 !== multisiteNotifications.indexOf(notification)
      ) {
        $('#email-formatting').hide()
      }
    } else if (
      'new-comment' === notification ||
      'approve' === check_comment[0] ||
      notification.startsWith('moderate-comment-') ||
      'new-trackback' === notification ||
      'new-pingback' === notification ||
      'admin-password' === notification ||
  ...
  $('#shortcode-help').on('click', function () {
    ...
    $(this).attr(
      'href',
      'https://betternotificationsforwp.com/documentation/notifications/shortcodes/?notification=' +
        notification_slug +
        '&utm_source=WP%20Admin%20Notification%20Editor%20-%20"Shortcode%20Help"&utm_medium=referral'
    )
  })
  ...
  $('#insert-default-msg').on('click', function () {
    ...
    switch (notification) {
      ...
      case 'reply-comment':
        ...
        body =
          'New comment on your post "[post_title]"<br>' +
      ...
      case 'admin-user':
        ...
        body =
          'New user registration on your site [global_site_title]: <br>' +
      ...
      case 'new-user':
        ...
        body = 'Username: [user_login] <br>' + 'To set your password, visit the following address: [password_url]'
      ...
      default:
        alert(
          "This is a new notification that is not available in WordPress by default and has been added by Better Notifications for WP. As such, it doesn't have any default content."
        )
        break
    }
